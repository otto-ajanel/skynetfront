// node_modules/@primevue/themes/index.mjs
...
var Theme = {
  ...
  transformCSS: function transformCSS() {
    var name = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
    var css = arguments.length > 1 ? arguments[1] : void 0;
...
var dtwt = function dtwt2() {
  ...
  if (tokenPath) {
    ...
    var _ref2 = (theme === null || theme === void 0 ? void 0 : theme.options) || OPTIONS || {}, prefix = _ref2.prefix, transform = _ref2.transform;
    var regex = /{([^}]*)}/g;
...
function toVariables(theme) {
  ...
  var _toVariables3 = _toVariables2(theme, prefix), variables = _toVariables3.variables, tokens = _toVariables3.tokens;
  return {
    value: variables,
    tokens,
...
var ThemeUtils = {
  ...
  getCommon: function getCommon2(_ref) {
    var _ref$name = _ref.name, name = _ref$name === void 0 ? "" : _ref$name, _ref$theme = _ref.theme, theme = _ref$theme === void 0 ? {} : _ref$theme;
    _ref.params;
    var set = _ref.set, defaults = _ref.defaults;
    var preset = theme.preset, options = theme.options;
  ...
  getPresetC: function getPresetC(_ref7) {
    ...
    var _ref7$name = _ref7.name, name = _ref7$name === void 0 ? "" : _ref7$name, _ref7$theme = _ref7.theme, theme = _ref7$theme === void 0 ? {} : _ref7$theme, params = _ref7.params, set = _ref7.set, defaults = _ref7.defaults;
    var preset = theme.preset, options = theme.options;
  ...
  getPresetD: function getPresetD(_ref8) {
    ...
    var _ref8$name = _ref8.name, name = _ref8$name === void 0 ? "" : _ref8$name, _ref8$theme = _ref8.theme, theme = _ref8$theme === void 0 ? {} : _ref8$theme, params = _ref8.params, set = _ref8.set, defaults = _ref8.defaults;
  ...
  getCommonStyleSheet: function getCommonStyleSheet2(_ref9) {
    var _ref9$name = _ref9.name, name = _ref9$name === void 0 ? "" : _ref9$name, _ref9$theme = _ref9.theme, theme = _ref9$theme === void 0 ? {} : _ref9$theme, params = _ref9.params, _ref9$props = _ref9.props, props = _ref9$props === void 0 ? {} : _ref9$props, set = _ref9.set, defaults = _ref9.defaults;
  ...
  getStyleSheet: function getStyleSheet2(_ref14) {
    var _ref15;
    var _ref14$name = _ref14.name, name = _ref14$name === void 0 ? "" : _ref14$name, _ref14$theme = _ref14.theme, theme = _ref14$theme === void 0 ? {} : _ref14$theme, params = _ref14.params, _ref14$props = _ref14.props, props = _ref14$props === void 0 ? {} : _ref14$props, set = _ref14.set, defaults = _ref14.defaults;
    var options = {
      name,
      theme,
      params,
  ...
  transformCSS: function transformCSS2(name, css, mode, type) {
...
function _unsupportedIterableToArray$32(r, a) {
  if (r) {
    if ("string" == typeof r)
      return _arrayLikeToArray$32(r, a);
    var t = {}.toString.call(r).slice(8, -1);
...
function _toPrimitive$1(t, r) {
  if ("object" != _typeof$22(t) || !t)
    return t;
  var e = t[Symbol.toPrimitive];
  if (void 0 !== e) {
    var i = e.call(t, r || "default");
    if ("object" != _typeof$22(i))
      return i;
    throw new TypeError("@@toPrimitive must return a primitive value.");
  }
  return ("string" === r ? String : Number)(t);
...
function _unsupportedIterableToArray$22(r, a) {
  if (r) {
    if ("string" == typeof r)
      return _arrayLikeToArray$22(r, a);
    var t = {}.toString.call(r).slice(8, -1);
...
var ObjectUtils = {
  ...
  minifyCSS: function minifyCSS2(css) {
    return css ? css.replace(/\/\*(?:(?!\*\/)[\s\S])*\*\/|[\r\n\t]+/g, "").replace(/ {2,}/g, " ").replace(/ ([{:}]) /g, "$1").replace(/([;,]) /g, "$1").replace(/ !/g, "!").replace(/: /g, ":") : css;
  }
};
function _typeof2(o) {
...
//# sourceMappingURL=chunk-UVXTW76P.js.map
