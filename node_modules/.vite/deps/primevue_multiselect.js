...
import {
  script as script4
} from "./chunk-OQOYVELS.js";
import "./chunk-XN5FGBK7.js";
import {
  script as script5
} from "./chunk-DZHIKZ2K.js";
import {
  OverlayEventBus
...
var script14 = {
  ...
  methods: {
    ...
    getOptionRenderKey: function getOptionRenderKey(option2, index) {
      return this.dataKey ? ObjectUtils.resolveFieldData(option2, this.dataKey) : this.getOptionLabel(option2) + "_".concat(index);
    },
    ...
    onOptionSelect: function onOptionSelect(event, option2) {
      ...
      if (selected)
        value = this.modelValue.filter(function(val) {
          return !ObjectUtils.equals(val, _this4.getOptionValue(option2), _this4.equalityKey);
        });
      else
        value = [].concat(_toConsumableArray(this.modelValue || []), [this.getOptionValue(option2)]);
      this.updateModel(event, value);
    ...
    getLabelByValue: function getLabelByValue(value) {
      ...
      var matchedOption = options2.find(function(option2) {
        return !_this9.isOptionGroup(option2) && ObjectUtils.equals(_this9.getOptionValue(option2), value, _this9.equalityKey);
      });
    ...
    findPrevSelectedOptionIndex: function findPrevSelectedOptionIndex(index) {
      var _this21 = this;
      var matchedOptionIndex = this.hasSelectedOption && index > 0 ? ObjectUtils.findLastIndex(this.visibleOptions.slice(0, index), function(option2) {
  ...
  computed: {
    ...
    allSelected: function allSelected() {
      var _this26 = this;
      return this.selectAll !== null ? this.selectAll : ObjectUtils.isNotEmpty(this.visibleOptions) && this.visibleOptions.every(function(option2) {
