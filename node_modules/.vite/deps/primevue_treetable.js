...
import "./chunk-FQU5WDVB.js";
import "./chunk-DZHIKZ2K.js";
import "./chunk-CEEFLI5H.js";
import "./chunk-5E6IKOVI.js";
import {
  script as script4
...
var script$1 = {
  ...
  methods: {
    ...
    onClick: function onClick2(event2) {
      if (DomHandler.isClickable(event2.target) || DomHandler.getAttribute(event2.target, "data-pc-section") === "rowtogglebutton" || DomHandler.getAttribute(event2.target, "data-pc-section") === "rowtoggleicon" || event2.target.tagName === "path") {
        return;
      }
    ...
    onTabKey: function onTabKey() {
      ...
      var hasSelectedRow = rows2.some(function(row2) {
        return DomHandler.getAttribute(row2, "data-p-selected") || row2.getAttribute("aria-checked") === "true";
      });
